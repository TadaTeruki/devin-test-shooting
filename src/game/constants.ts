...
export const BACKGROUND_LEAF_COLOR_DARK = "#8B4513"; // 暗い茶色
export const BACKGROUND_LEAF_COLOR_LIGHT = "#A0522D"; // 明るい茶色
export const BACKGROUND_LEAF_NOISE_SCALE = 0.006;
export const BACKGROUND_LEAF_NOISE_THRESHOLD = 0.3;
export const BACKGROUND_LEAF_COLOR_NOISE_SCALE_X = 0.015;
export const BACKGROUND_LEAF_COLOR_NOISE_SCALE_Y = 0.025;

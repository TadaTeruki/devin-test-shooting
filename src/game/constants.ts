...
export const BACKGROUND_CLOUD_COLOR = "#FFFFFF";
export const BACKGROUND_CLOUD_SHADOW_COLOR = "rgba(128, 128, 128, 0.3)";
export const BACKGROUND_CLOUD_RADIUS_MIN = 0;
export const BACKGROUND_CLOUD_RADIUS_VISIBLE = 25;
export const BACKGROUND_CLOUD_RADIUS_MAX = 40;
export const BACKGROUND_CLOUD_SHADOW_OFFSET_X = 20;
export const BACKGROUND_CLOUD_SHADOW_OFFSET_Y = 15;
export const BACKGROUND_CLOUD_NOISE_SCALE = 0.001;
export const BACKGROUND_CLOUD_SCROLL_SPEED_MULTIPLIER = 1.5;
